package org.harenoasa.summerframework.io.tests;
...
import org.harenoasa.summerframework.io.scan.proxy.*;
...
public class PostProcesserTest {
    @Test
...
//        assertSame(FirstProxyBean.class, proxy.getClass());
