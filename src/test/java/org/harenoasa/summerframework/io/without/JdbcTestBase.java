package org.harenoasa.summerframework.io.without;
...
public class JdbcTestBase {
    ...
    public static final String DROP_TABLE = "DROP TABLE IF EXISTS users, addresses";
...
//        ps.put("summer.datasource.driver-class-name", "org.sqlite.JDBC");
        ...
        Map<String, Object> yamlProperties = YamlUtils.loadYamlAsPlainMap("./application.yaml");
        ps.putAll(yamlProperties);
